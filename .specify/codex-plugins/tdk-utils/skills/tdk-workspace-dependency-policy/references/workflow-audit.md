...
Use audit mode to compare observed repo evidence against existing layout and
policy intent. It is observe-only.

1. Read layout, runtime config, existing policy artifacts, and bounded repo
   evidence.
...
5. Write `workspace-dependency-policy.md` with findings and next questions.
