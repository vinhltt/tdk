...
### Compliance
```bash
repomix --include "src/**,LICENSE,README.md,.specify/memory/**" --style markdown -o compliance.md
```
...
### Doc Context
```bash
repomix --include "src/**,.specify/memory/**,*.md" --style markdown -o doc-context.md
```
