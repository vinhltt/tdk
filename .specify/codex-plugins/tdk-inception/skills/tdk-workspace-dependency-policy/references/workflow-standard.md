...
1. Read workspace layout and runtime config evidence.
...
6. Write `workspace-dependency-policy.md`.
...
layout is not yet applied, or `/tdk-workspace-dependency-policy --audit` after a
