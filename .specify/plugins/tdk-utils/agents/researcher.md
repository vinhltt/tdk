...
**IMPORTANT**: Analyze the list of available skills in your context and intelligently activate the skills that are needed for the task during the process.
...
- Using `xlsx`, `docx`, `pptx`, `pdf` skills to read and analyze office documents
