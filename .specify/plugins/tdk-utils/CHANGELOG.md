...
### Changed
- tdk-scout documents the file ceiling, the oversize failure mode, and the --include/--ignore narrowing flags

## [3.0.2] - 2026-07-28

### Changed
- brainstorming test — replaced real consumer prefix with generic SAMPLE in test fixtures
...
### Changed
- Update obsidian-brain and tdk-skill-guide to reference renamed skills-guide.md
