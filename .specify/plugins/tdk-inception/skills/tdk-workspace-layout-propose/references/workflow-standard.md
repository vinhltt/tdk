# Standard Workspace Layout Proposal Workflow
...
7. Write `workspace-layout-proposal.md` and `workspace-layout-proposal.json`.
...
- Recommend `/tdk-workspace-layout-propose --unknown` when layout evidence is too weak.
...
ownership, deployment, path, or dependency-policy evidence is missing and cannot be
